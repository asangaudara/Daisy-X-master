...
PM_START_TEXT = """
Hello there, I'm [Asanga](https://telegra.ph/file/c2114c515c520855a9e37.jpg)
I'm Powerfull GP Bot 
✪ Make sure you read *WebSite* Section Below ✪ 
"""
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/c2114c515c520855a9e37.jpg)
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\nKeep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/c2114c515c520855a9e37.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} \n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [AsangaBro](https://asangabro.ga)"
            f"\n\n{dispatcher.bot.first_name} By Asanga_Udara"
